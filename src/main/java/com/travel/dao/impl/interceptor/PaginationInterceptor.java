package com.travel.dao.impl.interceptor;
...
import com.travel.util.Dialect;
import com.travel.util.MySql5Dialect;
...
public class PaginationInterceptor implements Interceptor{
    ...
    private MappedStatement copyFromMappedStatement(MappedStatement ms,   
    		...
    		builder.keyProperty(ms.getKeyProperties().toString());   //zhe li ke nenghui youwenti  wangji 
