    ...
    $(".sp1:eq(1)").click(function() {
        ...
        if ($val <= 1) {
            ...
            $(".bookprice").val($(this).next("input").val() * 200);
			 $(".realprice").val($(".bookprice").val()-$(".youhuiprice").val());
        }
    });
...
/*	$("btn-right").click(function() {
    ...
    function AddPerson(num) {
        $("#add").before("<li class='applicant' id = 'num'></li>");
        var $li=$("#add").prevAll("li:eq(0)");
        $li.append('<p class="message message2">入住人'+num+'</p>');
